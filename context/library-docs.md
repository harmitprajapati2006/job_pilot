...
- Adzuna description is a snippet — Groq (llama-3.3-70b-versatile) scores from it, not a full description
...
Three-step process: homepage extraction → sub-page extraction → Groq synthesis.
...
// Step 3 — Groq synthesis (after browser closes)
...
- Model is always `llama-3.3-70b-versatile` — never use other models
...
**Check first:** Check AGENTS.md for an installed Groq skill. The skill will have the latest API patterns and model capabilities.
...
- Model string is always `'llama-3.3-70b-versatile'` — never use other model names
